      ...
      <div className={`${styles.container} mb-[100px]`}>
        <div className="grid gap-4 lg:grid-cols-4 lg:grid-rows-2 lg:gap-6"> 
          ...
          <div className={`${styles.cardWrapper}`}>
            <div className={`${styles.card} bg-blue`}>
              <div>
                <Image src="/id-card.png" alt="id card icon" width={50} height={50} />
              </div>
              <div className={`${styles.cardTitle} text-blue-dark`}>About Me</div>
          ...
          <div className={`${styles.cardWrapper}`}>
            <div className={`${styles.card} bg-yellow`}>
              ...
              <div className={`${styles.cardTitle} text-yellow-dark`}>Frontend Developer</div>
          ...
          <div className={`${styles.cardWrapper}`}>
            <div className={`${styles.card} bg-sienna`}>
              ...
              <div className={`${styles.cardTitle} text-sienna-dark`}>Illustrator</div>
          ...
          <div className={`${styles.cardWrapper}`}>
            <div className={`${styles.card} bg-citron`}>
              ...
              <div className={`${styles.cardTitle} text-citron-dark`}>Skills</div>
          ...
          <div className={`${styles.cardWrapper}`}>
            <div className={`${styles.card} bg-dutch-white`}>
              ...
              <div className={`${styles.cardTitle} text-dutch-white-dark`}>Projects</div>
          ...
          <div className={`${styles.cardWrapper}`}>
            <div className={`${styles.card} bg-melon`}>
              ...
              <div className={`${styles.cardTitle} text-melon-dark`}>Professional Development</div>
              <ul className="text-[14px] list-disc ml-4">
